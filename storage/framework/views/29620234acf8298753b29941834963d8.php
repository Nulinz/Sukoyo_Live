<nav class="navbar px-4">
    <div class="icons login col-sm-12 col-md-12">
        ...
        <div class="navlogo">
            <a href="<?php echo e(route('login')); ?>" class="mx-auto">
                <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="" height="30px" class="mx-auto">
            </a>
        </div>
...
<div class="modal fade" id="password" tabindex="-1" aria-labelledby="passwordLabel" aria-hidden="true">
    ...
    <div class="col-sm-12 col-md-12 mb-2">
        ...
        <div class="inpflex">
            <input type="password" class="form-control border-0" name="oldpassword" id="password_1" required>
    ...
    <div class="col-sm-12 col-md-12 mb-2">
        ...
        <div class="inpflex">
            <input type="password" class="form-control border-0" name="newpassword" id="password_2" required>
    ...
    <div class="col-sm-12 col-md-12 mb-2">
        ...
        <div class="inpflex">
            <input type="password" class="form-control border-0" name="confirmpassword" id="password_3" required>
    ...
    <div class="d-flex justify-content-between align-items-center gap-2 mx-auto mt-3">
        ...
        <button type="submit" class="modalbtn w-50">Change</button>
    </div>
</form>
...
</div><?php /**PATH C:\xampp\htdocs\Sukoyo_Live\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>