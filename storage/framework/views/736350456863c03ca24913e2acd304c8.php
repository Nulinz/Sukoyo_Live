...
<div class="body-div p-3">
    ...
    <form action="<?php echo e(route('purchase.order_update', $purchaseOrder->id)); ?>" method="POST" id="purchaseOrderForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="container-fluid form-div">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo e($purchaseOrder->vendor->vendorname); ?>" readonly>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Contact Number <span>*</span></label>
                    <input type="text" class="form-control" value="<?php echo e($purchaseOrder->contact); ?>" readonly>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Billing Address</label>
                    <textarea rows="1" class="form-control" readonly><?php echo e($purchaseOrder->billaddress); ?></textarea>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Bill No <span>*</span></label>
                    <input type="text" class="form-control" value="<?php echo e($purchaseOrder->bill_no); ?>" readonly>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Bill Date <span>*</span></label>
                    <input type="date" class="form-control" value="<?php echo e($purchaseOrder->bill_date); ?>" readonly>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Due Date <span>*</span></label>
                    <input type="date" class="form-control" value="<?php echo e($purchaseOrder->due_date); ?>" readonly>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Transport Charge</label>
                    <input type="number" step="0.01" class="form-control" name="transport" value="<?php echo e($purchaseOrder->transport); ?>">
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Packaging Charge</label>
                    <input type="number" step="0.01" class="form-control" name="packaging" value="<?php echo e($purchaseOrder->packaging); ?>">
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Store / Warehouse <span>*</span></label>
                    <select class="form-select" disabled>
                        <option value="" disabled <?php echo e($purchaseOrder->warehouse == null ? 'selected' : ''); ?>>Select Option</option>
                        <option value="Store" <?php echo e($purchaseOrder->warehouse == 'Store' ? 'selected' : ''); ?>>Store</option>
                        <option value="Warehouse" <?php echo e($purchaseOrder->warehouse == 'Warehouse' ? 'selected' : ''); ?>>Warehouse</option>
                    </select>
                    <input type="hidden" name="warehouse" value="<?php echo e($purchaseOrder->warehouse); ?>">
                </div>
            </div>
                ...
                <div class="table-wrapper">
                    <table class="example table table-bordered" id="itemTable">
                        ...
                        <tbody id="itemsBody">
                            ...
                            <tr data-row="<?php echo e($index); ?>" data-item-id="<?php echo e($item->item_id); ?>" data-item-name="<?php echo e($item->item->item_name ?? 'Unknown Item'); ?>">
                                <td class="serial-no"><?php echo e($index+1); ?></td>
                                <td>
                                    <!-- Display Mode -->
                                    <div class="item-display"><?php echo e($item->item->item_name ?? 'Unknown Item'); ?></div>
                                    ...
                                    <input type="hidden" class="item-id-input" name="items[<?php echo e($index); ?>][item_id]" value="<?php echo e($item->item_id); ?>">
                                </td>
                                <td>
                                    <select class="form-select unit-select" style="width: 100px" name="items[<?php echo e($index); ?>][unit]" required disabled>
                                        <option value="" disabled>Select Unit</option>
                                        <option value="kg" <?php echo e($item->unit == 'kg' ? 'selected' : ''); ?>>kg</option>
                                        <option value="g" <?php echo e($item->unit == 'g' ? 'selected' : ''); ?>>g</option>
                                        <option value="litre" <?php echo e($item->unit == 'litre' ? 'selected' : ''); ?>>litre</option>
                                        <option value="ml" <?php echo e($item->unit == 'ml' ? 'selected' : ''); ?>>ml</option>
                                        <option value="pcs" <?php echo e($item->unit == 'pcs' ? 'selected' : ''); ?>>pcs</option>
                                        <option value="pack" <?php echo e($item->unit == 'pack' ? 'selected' : ''); ?>>pack</option>
                                        <option value="box" <?php echo e($item->unit == 'box' ? 'selected' : ''); ?>>box</option>
                                        <option value="dozen" <?php echo e($item->unit == 'dozen' ? 'selected' : ''); ?>>dozen</option>
                                    </select>
                                </td>
                                <td><input type="number" step="0.01" class="form-control qty-input" name="items[<?php echo e($index); ?>][qty]" value="<?php echo e($item->qty); ?>" required readonly></td>
                                <td><input type="number" step="0.01" class="form-control price-input" name="items[<?php echo e($index); ?>][price]" value="<?php echo e($item->price); ?>" required readonly></td>
                                <td><input type="number" step="0.01" class="form-control discount-input" name="items[<?php echo e($index); ?>][discount]" value="<?php echo e($item->discount); ?>" readonly></td>
                                <td><input type="number" step="0.01" class="form-control tax-input" name="items[<?php echo e($index); ?>][tax]" value="<?php echo e($item->tax); ?>" readonly></td>
                                <td><input type="number" step="0.01" class="form-control amount-input" name="items[<?php echo e($index); ?>][amount]" value="<?php echo e($item->amount); ?>" readonly></td>
                                <td>
            ...
            <div class="row mt-3">
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo e($purchaseOrder->payment_type); ?>" disabled>
                    <input type="hidden" name="payment_type" value="<?php echo e($purchaseOrder->payment_type); ?>">
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Reference No</label>
                    <input type="text" class="form-control" name="reference_no" value="<?php echo e($purchaseOrder->reference_no); ?>">
                </div>
                <div class="col-sm-12 col-md-8 col-xl-6 mb-3">
                    <label>Description</label>
                    <textarea rows="1" class="form-control" name="description"><?php echo e($purchaseOrder->description); ?></textarea>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Total <span>*</span></label>
                    <input type="number" step="0.01" class="form-control" name="total" id="totalField" value="<?php echo e($purchaseOrder->total); ?>" required readonly>
                ...
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" name="paid_amount" id="paidField" value="<?php echo e($purchaseOrder->paid_amount); ?>" required>
                </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    <label>Balance Amount <span>*</span></label>
                    <input type="number" step="0.01" class="form-control" name="balance_amount" id="balanceField" value="<?php echo e($purchaseOrder->balance_amount); ?>" required readonly>
                    <div class="round-off-wrapper">
...
<script>
// Global variables
let rowIndex = <?php echo e(count($purchaseOrder->items)); ?>;
let itemsData = <?php echo json_encode($items, 15, 512) ?>;
...
function submitInChunks() {
    ...
    $.ajax({
        ...
        success: function(response) {
            window.location.href = response.redirect || '<?php echo e(route("purchase.order_list")); ?>';
        },
        error: function(xhr) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/purchase/order_edit.blade.php ENDPATH**/ ?>