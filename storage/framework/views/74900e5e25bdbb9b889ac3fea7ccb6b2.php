...
<tbody>
    <?php $__currentLoopData = $salesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <tr>
            ...
            <td><?php echo e($employee->empname ?? 'Unknown'); ?></td>
            <td><?php echo e($storeName); ?></td>
            <td>₹ <?php echo e(number_format($data->cash_sales, 2)); ?></td>
            <td>₹ <?php echo e(number_format($data->online_sales, 2)); ?></td>
            <td>₹ <?php echo e(number_format($collectedAmount, 2)); ?></td>
            <td>
                <span class="text-<?php echo e($status == 'Collected' ? 'success' : 'danger'); ?>">
                    <?php echo e($status); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/accounts/cash.blade.php ENDPATH**/ ?>