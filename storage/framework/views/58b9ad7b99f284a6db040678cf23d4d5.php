...
<div class="body-div p-3">
    ...
    <form method="POST" action="<?php echo e(route('purchase.order_store')); ?>" id="purchaseOrderForm">
        <?php echo csrf_field(); ?>
...
<div class="col-sm-12 col-md-4 col-xl-3 mb-3">
    ...
    <textarea rows="1" class="form-control" name="billaddress" id="billaddress" readonly></textarea>
                ...
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                    ...
                    <?php else: ?>
                        <!-- Manager: fixed store -->
                        <input type="text" class="form-control" name="warehouse" value="<?php echo e($stores[0]->store_name); ?>" readonly>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/purchase/order_add.blade.php ENDPATH**/ ?>