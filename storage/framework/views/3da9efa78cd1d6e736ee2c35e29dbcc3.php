        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('inventory.brandbulkupload')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <a href="<?php echo e(asset('public/sample/brand.csv')); ?>" download class="text-primary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sukoyo_Live\resources\views/inventory/brand_list.blade.php ENDPATH**/ ?>