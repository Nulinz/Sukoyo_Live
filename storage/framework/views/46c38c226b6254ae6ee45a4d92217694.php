    ...
    <script>
        $(document).ready(function () {
            ...
            let table = $('.example').DataTable({
                ...
                pageLength: 10,
                ajax: {
                    url: "<?php echo e(route('stock.getLowStockItems')); ?>",
                    type: 'GET',
                    data: function (d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sukoyo_Live\resources\views/stock/lowstock_list.blade.php ENDPATH**/ ?>