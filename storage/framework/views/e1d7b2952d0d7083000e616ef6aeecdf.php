        ...
        <div class="filter-container no-print">
            ...
            <div class="filter-container-end">
                ...
                <div class="d-flex gap-2">
                    <a href="<?php echo e(request()->fullUrlWithQuery(['download' => 'csv'])); ?>" class="btn btn-outline-primary btn-sm no-print">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if($item->sales_quantity > 0): ?>
                                    <?php echo e(number_format($item->sales_quantity, 0)); ?> PCS
                                <?php else: ?>
                                    0 PCS
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <?php if($item->purchase_quantity > 0): ?>
                                    <?php echo e(number_format($item->purchase_quantity, 0)); ?> PCS
                                <?php else: ?>
                                    0 PCS
                                <?php endif; ?>
                            </td>
                    ...
                    <tfoot>
                        <tr class="table-secondary">
                            ...
                            <th class="text-center">
                                <?php echo e(number_format($totalSalesQty)); ?> PCS
                            </th>
                            <th class="text-center">
                                <?php echo e(number_format($totalPurchaseQty)); ?> PCS
                            </th>
                        </tr>
                    </tfoot>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/reports/item.blade.php ENDPATH**/ ?>