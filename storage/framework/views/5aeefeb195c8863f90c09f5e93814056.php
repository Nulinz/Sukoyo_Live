                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <img src="<?php echo e(asset('assets/images/icon_7.png')); ?>" height="15px">
...
<div class="modal fade" id="customer" tabindex="-1" aria-labelledby="customerLabel" aria-hidden="true">
    ...
    <div class="row">
        ...
        <div class="col-12 mb-2" id="addCustomerBtnDiv" style="display: none;">
            <button type="button" class="btn btn-success btn-sm" onclick="addNewCustomer()">+ Add New Customer</button>
        </div>
...
</script><?php /**PATH C:\xampp\htdocs\Sukoyo_Live\resources\views/pos/pos_popups.blade.php ENDPATH**/ ?>