    ...
    <div class="modal-content">
      <form action="<?php echo e(route('party.vendorbulkupload')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="my-2">
            <a href="<?php echo e(asset('sample/vendors.csv')); ?>" download class="text-primary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/party/vendor_list.blade.php ENDPATH**/ ?>