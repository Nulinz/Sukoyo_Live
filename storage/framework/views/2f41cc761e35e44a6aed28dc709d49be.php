<?php $__env->startSection('content'); ?>
    ...
    <div class="body-div p-3">
        ...
        <form action="<?php echo e(route('class.bookingsstore')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="contact_number" id="contact_number" 
                            ...
                            <small id="student-message" class="d-block mt-1"></small>
                    </div>                    
                    <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
        ...
        $(document).ready(function() {
            ...
            $('#class_type').change(function() {
                ...
                if (classType) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('class.getbytype')); ?>",
                        type: "POST",
                        data: {
            ...
            $('#class_name').change(function() {
                ...
                if (className) {
                    $.ajax({
                        url: "<?php echo e(route('class.getdetails')); ?>",
                        type: "POST",
                        data: {
...
<script>
    ...
    if (contact.length === 10) {
        ...
        $.ajax({
            url: "<?php echo e(route('class.getstudentbycontact')); ?>",
            type: "POST",
            ...
            success: function(response) {
                if (response.status === 'found') {
                    ...
                    $('#emergency_contact').val(student.emergency_contact);
                    ...
                    $('#student-message')
                        ...
                        .text('Existing student details loaded.');
                } else {
                    // Clear fields for new student
                    $('#student_id, #student_name, #email, #date_of_birth, #guardian_name, #emergency_contact, #address, #city, #state, #pincode').val('');
                    $('#gender').val('');

                    $('#student-message')
                        .removeClass('text-success')
                        .addClass('text-danger')
                        .text('New student - please fill the details.');
                }
            },
            error: function() {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/classes/bookings/add.blade.php ENDPATH**/ ?>