...
<div class="body-div p-3" id="print-area">
    ...
    <div class="container-fluid mt-3 listtable">
        <div class="filter-container no-print">
            ...
            <div class="filter-container-end">
                ...
                <select class="form-select" name="profit_filter" id="profit_filter">
                    <option value="all" <?php echo e($profitFilter == 'all' ? 'selected' : ''); ?>>All Bills</option>
                    <option value="profit" <?php echo e($profitFilter == 'profit' ? 'selected' : ''); ?>>Profitable</option>
                    <option value="loss" <?php echo e($profitFilter == 'loss' ? 'selected' : ''); ?>>Loss Making</option>
                    <option value="break_even" <?php echo e($profitFilter == 'break_even' ? 'selected' : ''); ?>>Break Even</option>
                </select>
        ...
        <!-- <div class="row mb-3 no-print">
            <div class="col-lg-2 col-md-4 col-sm-6 mb-2">
                <div class="info-box bg-info text-white">
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalBills"><?php echo e(number_format($totalBills)); ?></span>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 mb-2">
                <div class="info-box bg-success text-white">
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalRevenue">₹<?php echo e(number_format($totalRevenue, 2)); ?></span>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 mb-2">
                <div class="info-box bg-warning text-white">
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number" id="totalCost">₹<?php echo e(number_format($totalCostPrice, 2)); ?></span>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 mb-2">
                <div class="info-box <?php echo e($totalProfit >= 0 ? 'bg-success' : 'bg-danger'); ?> text-white">
                    <div class="info-box-content">
                        <span class="info-box-text">Total Profit</span>
                        <span class="info-box-number" id="totalProfit">₹<?php echo e(number_format($totalProfit, 2)); ?></span>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 mb-2">
                <div class="info-box <?php echo e($avgProfitMargin >= 0 ? 'bg-success' : 'bg-danger'); ?> text-white">
                    <div class="info-box-content">
                        <span class="info-box-text">Avg Profit %</span>
                        <span class="info-box-number" id="avgProfit"><?php echo e(number_format($avgProfitMargin, 2)); ?>%</span>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 mb-2">
                <div class="info-box bg-light text-dark">
                    <div class="info-box-content">
                        <span class="info-box-text">P: <?php echo e($profitableBills); ?> | L: <?php echo e($lossBills); ?></span>
...
<script>
    ...
    function loadBillProfitData() {
        ...
        fetch(`<?php echo e(route('reports.bill_wise_profit_items')); ?>?${params.toString()}`)
    ...
    function populateTable(bills) {
        ...
        bills.forEach((bill, idx) => {
            ...
            const storeColumn = <?php echo e(session('role') !== 'manager' ? 'true' : 'false'); ?> ? 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/reports/bill_wise_profit.blade.php ENDPATH**/ ?>