...
<div class="body-div p-3">
    ...
    <tr>
        ...
        <td><?php echo e($store->contact_number); ?></td>
        <td><?php echo e($store->city); ?></td>
        <td>
            <div class="d-flex align-items-center gap-2">
                <a href="<?php echo e(route('store.toggle_status', $store->id)); ?>" data-bs-toggle="tooltip"
       data-bs-title="<?php echo e($store->status == 'Active' ? 'Deactivate' : 'Activate'); ?>">
        ...
        <?php endif; ?>
                ...
                <a data-bs-toggle="modal" data-bs-target="#editStore<?php echo e($store->id); ?>">
                    <i class="fas fa-pen-to-square"></i>
                </a>
              <a href="<?php echo e(route('store.profile', $store->id)); ?>" data-bs-toggle="tooltip" title="View Store Profile">
    ...
    <div class="modal fade" id="editStore<?php echo e($store->id); ?>" tabindex="-1">
                    ...
                    <form action="<?php echo e(route('store.update', $store->id)); ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="store_id" value="<?php echo e($store->store_id); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>Store Name</label>
                                <input type="text" class="form-control" name="store_name" value="<?php echo e($store->store_name); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>Email ID</label>
                                <input type="email" class="form-control" name="email" value="<?php echo e($store->email); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>Contact Number</label>
                                <input type="text" class="form-control" name="contact_number" value="<?php echo e($store->contact_number); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>Address</label>
                                <input type="text" class="form-control" name="address" value="<?php echo e($store->address); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>City</label>
                                <input type="text" class="form-control" name="city" value="<?php echo e($store->city); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>State</label>
                                <input type="text" class="form-control" name="state" value="<?php echo e($store->state); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>Pincode</label>
                                <input type="text" class="form-control" name="pincode" value="<?php echo e($store->pincode); ?>" required>
                            </div>
                            <div class="col-sm-12 col-md-6 mb-2">
                                <label>Geo Location</label>
                                <input type="text" class="form-control" name="geo_location" value="<?php echo e($store->geo_location); ?>" required>
                            </div>
...
<div class="modal fade" id="addStore" tabindex="-1" aria-labelledby="addStoreLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('store.add')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-sm-12 col-md-6 mb-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/store/list.blade.php ENDPATH**/ ?>