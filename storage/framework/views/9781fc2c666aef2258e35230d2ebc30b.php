...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(asset('assets/images/favicon.png')); ?>" sizes="32*32" type="image/png">
...
<body>
    <!-- Loader -->
    <?php echo $__env->make('loader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="main-body">
        <div class="signup">
            <div class="logo d-flex justify-content-center align-items-center">
                <img src="<?php echo e(asset('assets/images/login_logo.png')); ?>" height="50px" alt="">
            </div>
                ...
                <form action="<?php echo e(route('login.submit')); ?>" method="POST" id="loginForm">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 mb-4">
                            ...
                            <div class="inpflex">
                                <img src="<?php echo e(asset('assets/images/login_user.png')); ?>" height="20px" class="d-flex mx-auto" alt="">
                        ...
                        <div class="col-sm-12 col-md-12 mb-4">
                            ...
                            <div class="inpflex">
                                <img src="<?php echo e(asset('assets/images/login_lock.png')); ?>" height="20px" class="d-flex mx-auto" alt="">
...
</html><?php /**PATH C:\xampp\htdocs\Sukoyo_Live\resources\views/index.blade.php ENDPATH**/ ?>