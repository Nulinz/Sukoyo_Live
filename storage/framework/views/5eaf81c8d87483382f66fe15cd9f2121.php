...
<div class="body-div p-3">
    ...
    <form action="<?php echo e(route('inventory.itemstore')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<script>
    $('#category').on('change', function () {
        ...
        if (categoryId) {
            $.ajax({
                url: "<?php echo e(url('/get-subcategories-by-category')); ?>",
                type: "GET",
...
<script>
    ...
    if (itemCode) {
        $.ajax({
            url: "<?php echo e(url('/check-item-code')); ?>",
            type: "GET",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/inventory/item_add.blade.php ENDPATH**/ ?>