...
<div class="body-div p-3">
    ...
    <div class="col-sm-12 col-md-12 col-xl-12 mb-2">
        <h5 class="mb-2"><?php echo e($item->item_name); ?></h5>
<h6 class="mb-0">
    In Stock - <?php echo e($currentStock); ?> <?php echo e(strtoupper($item->opening_unit)); ?>
    ...
    <h4><?php echo e($item->brand->brand_name ?? '-'); ?> <?php echo e($item->item_name); ?></h4>
                ...
                <ul class="nav nav-tabs d-flex justify-content-start align-items-center gap-2 gap-lg-3" id="myTab"
                    ...
                    <li class="nav-item mb-2" role="presentation">
                        <button class="profiletabs active" data-bs-toggle="tab" type="button" data-bs-target="#details">
                            <img src="<?php echo e(asset('assets/images/profile_info.png')); ?>" class="pe-1" height="13px" alt=""> Details
                        </button>
                    </li>
                    <li class="nav-item mb-2" role="presentation">
                        <button class="profiletabs" data-bs-toggle="tab" type="button" data-bs-target="#stock">
                            <img src="<?php echo e(asset('assets/images/profile_stock.png')); ?>" class="pe-1" height="13px" alt=""> Stock Details
                        </button>
                    </li>
                    <li class="nav-item mb-2" role="presentation">
                        <button class="profiletabs" data-bs-toggle="tab" type="button" data-bs-target="#uom">
                            <img src="<?php echo e(asset('assets/images/profile_uom.png')); ?>" class="pe-1" height="10px" alt=""> UOM
                        </button>
                    </li>
                    <li class="nav-item mb-2" role="presentation">
                        <button class="profiletabs" role="tab" data-bs-toggle="tab" type="button" data-bs-target="#batch">
                            <img src="<?php echo e(asset('assets/images/profile_batch.png')); ?>" class="pe-1" height="13px" alt="">Batch
                        </button>
                    </li>
                </ul>
                <div class="body-head d-flex align-items-center flex-wrap gap-3">
                    <h5 class="text-decoration-none">Current Stock: <span><?php echo e($currentStock); ?></span></h5>
                    <h5 class="text-decoration-none">Stock Value: <span> ₹<?php echo e(number_format($stockValue, 2)); ?></span></h5>
                </div>
            </div>
  ...
  <div class="cards mb-2">
    ...
    <div class="maincard row py-0 mb-3">
        ...
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            ...
            <h5 class="mb-0"><?php echo e($item->item_type); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Item Code</h6>
            <h5 class="mb-0"><?php echo e($item->item_code); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Item Name</h6>
            <h5 class="mb-0"><?php echo e($item->item_name); ?></h5>
        </div>
                <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">HSN Code</h6>
            <h5 class="mb-0"><?php echo e($item->hsn_code); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Brand</h6>
            <h5 class="mb-0"><?php echo e($item->brand->name ?? '-'); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Category</h6>
            <h5 class="mb-0"><?php echo e($item->category->name ?? '-'); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Sub Category</h6>
            <h5 class="mb-0"><?php echo e($item->subcategory->name ?? '-'); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Discount</h6>
            <h5 class="mb-0"><?php echo e($item->discount); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Measuring Unit</h6>
            <h5 class="mb-0"><?php echo e($item->measure_unit); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Opening Stock</h6>
            <h5 class="mb-0"><?php echo e($item->opening_stock); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Low Stock Warning</h6>
            <h5 class="mb-0"><?php echo e($item->stock_status); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Minimum Stock</h6>
            <h5 class="mb-0"><?php echo e($item->min_stock); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Maximum Stock</h6>
            <h5 class="mb-0"><?php echo e($item->max_stock); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">ABC Category</h6>
            <h5 class="mb-0"><?php echo e($item->abc_category); ?></h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Item Description</h6>
            <h5 class="mb-0"><?php echo e($item->item_description ?? 'Nil'); ?></h5>
        </div>
    </div>
    ...
    <div class="maincard row py-0 mb-3">
        ...
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            ...
            <h5 class="mb-0">₹ <?php echo e(number_format($item->sales_price, 2)); ?> with GST</h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Wholesale Price</h6>
            <h5 class="mb-0">₹ <?php echo e(number_format($item->wholesale_price, 2)); ?> with GST</h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            <h6 class="mb-1">Purchase Price</h6>
<h5 class="mb-0">
    ₹ <?php echo e(number_format($item->purchase_price, 2)); ?> 
    <?php echo e($item->purchase_tax ?? 'With Tax'); ?>
        ...
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            ...
            <h5 class="mb-0"><?php echo e($item->gst_rate); ?>%</h5>
        </div>
    </div>
</div>
...
<div class="table-wrapper">
    <table class="table table-bordered" id="table1">
        ...
        <tbody>
        <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $txn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e($index + 1); ?></td>
                
                <td>
                    <?php echo e($txn->created_at ? \Carbon\Carbon::parse($txn->created_at)->format('d-m-Y') : \Carbon\Carbon::parse($txn->date)->format('d-m-Y')); ?>

                </td>
                
                <td><?php echo e($txn->transaction_type); ?></td>
                
                <td><?php echo e($txn->vendor_name); ?></td>
                
                <td><?php echo e($txn->invoice_no); ?></td>
                
                <td>
                    <?php if($txn->bill_date && $txn->bill_date !== '-'): ?>
                        <?php echo e(\Carbon\Carbon::parse($txn->bill_date)->format('d-m-Y')); ?>

                    <?php else: ?>
                        <?php echo e($txn->bill_date); ?>

                    <?php endif; ?>
                </td>
                
                <td><?php echo e($txn->qty); ?></td>
                
                <td>
                    <?php if($loop->last): ?>
                        <strong><?php echo e($currentStock); ?></strong>
                    <?php else: ?>
                        <?php echo e($txn->closing_stock); ?>
...
<br>
        <div class="table-wrapper">
            <table class="table table-bordered" id="table2">
                ...
                <tbody>
                    <?php $__currentLoopData = $uoms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $uom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($index + 1); ?></td>
                            <td><?php echo e($uom->uom_type); ?></td>
                            <td><?php echo e($uom->qty); ?></td>
                            <td>₹ <?php echo e(number_format($uom->rate_per_box, 2)); ?></td>
                            <td><?php echo e($uom->closing_stock); ?></td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#editUOM"
                                       onclick="editUOM(<?php echo e($uom->id); ?>)">
    ...
    <div class="modal fade" id="addUOM" tabindex="-1" aria-labelledby="addUOMLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <form action="<?php echo e(url('/uom')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
        ...
        .then(data => {
            ...
            document.getElementById('editUOMForm').action = `/uom/update/${data.id}`;
                ...
                <div class="tab-pane fade" id="batch" role="tabpanel">
                    <?php echo $__env->make('inventory.prof_batch', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="d-flex align-items-center justify-content-center flex-wrap gap-4 my-3">
                            <div class="barcodeimg">
                                <img src="<?php echo e(asset('assets/images/Barcode.png')); ?>" height="75px" alt="">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 mb-2 pe-md-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/sukoyo/resources/views/inventory/item_profile.blade.php ENDPATH**/ ?>