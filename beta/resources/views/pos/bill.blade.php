    ...
    <div class="bill-div">
        ...
        <div class="bill-body">
            <div class="bill-body-left pt-3">
                <div class="table-wrapper">
                    ...
                    <div class="row g-2">
                        <div class="col-md-5">
                            <div class="barcode-input">
                                <input type="text" id="barcodeInput" class="form-control"
                                    placeholder="Scan or enter barcode and press Enter..." autocomplete="off"
                        ...
                        <div class="col-md-3">
                            <button type="button" id="manualSelect" class="btn btn-outline-secondary w-100"
                                style="height:40px;" data-bs-toggle="modal" data-bs-target="#itemSelectModal">
                                <i class="fas fa-list"></i> Manual Select
                            </button>
                        </div>
                        <div class="col-md-3">
                            <button type="button" class="btn btn-info w-100" style="height:40px;"
                                onclick="document.getElementById('barcodeInput').focus();">
                                <i class="fas fa-keyboard"></i> Focus Scanner
                            </button>
                        </div>
                        <div class="col-md-1">
                            <button type="button" class="btn btn-info w-100 check_dummy" style="height:40px;"
                                data-bs-toggle="modal" data-bs-target="#manual_item">
                                + Item
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="mt-2">
                        <small class="text-muted">
                            ...
                            Scan barcode or type item code and press Enter. Items will be automatically added with
                            quantity 1.
                        </small>
                    </div>

                    <!-- Added Items Table -->
                    <table class="table-bordered mt-4 table" id="addedTable" style="display:none">
                        <thead>
                            <tr>
                                <th style="width: 5%;">#</th>
                        ...
                        <tfoot style="display: none;" id="tableFooter">
                            <tr class="table-info">
                                <td colspan="7" class="fw-bold text-end">Total Items:</td>
            ...
            <div class="bill-body-right pt-3">
                <div class="offerbtns">
                    <button type="button" class="listbtn mb-2 px-1" data-bs-toggle="modal" data-bs-target="#discount">
                        Add Discount [F5]
                    </button>
                    <button type="button" class="listbtn mb-2 px-1" data-bs-toggle="modal"
                        data-bs-target="#additional">
                        Additional Charges [F6]
                    </button>
                    <button type="button" class="listbtn mb-2 px-1" data-bs-toggle="modal" data-bs-target="#lp">
                        Loyalty Points [F7]
                    </button>
                    <button type="button" class="listbtn mb-2 px-1" data-bs-toggle="modal" data-bs-target="#giftcards">
                        Gift Cards & Vouchers
                    </button>
                </div>
                ...
                <div class="details mt-3">
                    ...
                    <hr class="m-0">
                    <div class="mt-2">
                        <p class="fw-semibold text-dark mb-1">Sukoyo Store</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="text-muted mb-0" id="selectedCustomer">
                            ...
                            <div class="d-flex flex-column align-items-end gap-1">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="text-muted" id="loyaltyPointsDisplay">
                                        @if (!empty($customer_name) && !empty($customer_contact))
                                            {{ \App\Models\Customer::where('contact', $customer_contact)->value('loyalty_points') ?? 0 }}
                                            Points
                                        @else
                                            0 Points
                                        @endif
                                ...
                                <div style="display: none;" id="usedPointsContainer">
                                    <small class="text-warning">Used Points: <span
                                            id="usedPointsDisplay">0</span></small>
                                </div>
                                <div style="display: none;" id="remainingPointsContainer">
                                    <small class="text-success">Remaining Points: <span
                                            id="remainingPoints">0</span></small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="details mt-3">
                    ...
                    <hr class="m-0">
                    <table class="table-borderless mb-0 mt-2 table">
                        <tbody>
                            <tr>
                                ...
                                <th class="text-start">
                                    <div id="singlePaymentInput">
                                        <input type="number" class="form-control" id="receivedAmount"
                                            placeholder="Enter amount" value="0" min="0" step="0.01">
                                    </div>
                ...
                <div class="offerbtns mt-3">
                    <form id="posForm">
                        ...
                        <button type="button" class="listbtn mb-2 px-1" id="savePrintBtn">Save & Print </button>
                        <button type="button" class="listbtn mb-2 px-1" onclick="validateAndOpenCorporateBill()"
                            data-bs-toggle="modal" data-bs-target="#corporateBillOptions">Corporate Bill</button>

                    </form>
                    <!--<button type="button" class="listbtn mb-2 px-1">Save & Print [F12]</button>-->
                </div>
                <script>
                    function validateAndOpenCorporateBill() {
                        ...
                        if (receivedAmount < grandTotal) {
                            const proceed = confirm(
                                `Received amount (₹${receivedAmount.toFixed(2)}) is less than bill total (₹${grandTotal.toFixed(2)}). Do you want to proceed?`
                            );
                            if (!proceed) {
                                if (mopValue === 'Both') {
                                    $('#cashAmount').focus();
...
<div class="modal fade" id="itemSelectModal" tabindex="-1" aria-labelledby="itemSelectModalLabel"
    aria-hidden="true">
                ...
                <form id="discountForm">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 mb-3">
                            ...
                            <div class="d-flex align-items-center mt-2 gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="discountTiming"
                                        value="before" id="before" checked>
                                    <label class="form-check-label" for="before">Before Tax</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="discountTiming"
                                        value="after" id="after">
                            ...
                            <div class="d-flex align-items-center mt-2 gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="discountType"
                                        value="percentage" id="discountPercentage" checked>
                                    <label class="form-check-label" for="discountPercentage">Percentage (%)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="discountType"
                                        value="amount" id="discountAmount">
                        ...
                        <div class="col-sm-12 col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control" id="percentage" min="0"
                                max="100" step="0.01" placeholder="Enter percentage">
                        </div>

                        <div class="col-sm-12 col-md-12 mb-3">
                            <label for="discamount" class="form-label">Amount (₹)</label>
                            <input type="number" class="form-control" id="discamount" min="0"
...
<div class="modal fade" id="manual_item" tabindex="-1" aria-labelledby="customerLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="manualItemForm">
                    <input type="hidden" name="stock" value="1000">
                    <input type="hidden" name="item_id" id="dummy_item">
                    <div class="row">
                        <div class="col-sm-12 mb-2">
                            <label>Item Name <span>*</span></label>
                            <input type="text" class="form-control" name="item_name" id="manual_item_name"
                                required>
                        </div>

                        <div class="col-sm-12 mb-3">
                            <label>Measuring Unit <span>*</span></label>
                            <select class="form-select" name="measure_unit" id="manual_measure_unit" required>
                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <select class="form-select" name="gst_rate" id="manual_gst_rate" required>
                                <option value="" disabled selected>Select</option>
                        ...
                        <div class="col-sm-12 mb-2">
                            ...
                            <input type="number" class="form-control" id="manual_price" required>
                        </div>

                        <div class="d-flex mt-3 gap-2">
                            <button type="button" data-bs-dismiss="modal" class="cancelbtn w-50">Cancel</button>
                            <button type="submit" class="modalbtn w-50 select-manual-item-btn">Save</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
            ...
            fetch(url, {
                ...
                .then(data => {
                    if (data.status) {
                        ...
                        // console.log(
                        //     `Loaded chunk ${chunk}: ${data.data.length} items (Total: ${loadedItemsCount}/${totalItemsCount})`
                        // );
            ...
            if (additionalChargesInput) {
                additionalChargesInput.addEventListener('input', function() {
                    ...
                    document.getElementById('additionalCharges').textContent =
                        `₹ ${additionalChargesAmount.toFixed(2)}`;
                    updateTotals();
                });
            }
            return;
    ...
    function processBarcode() {
        ...
        if (item) {
            ...
            if (item.item_type === 'batch' && item.exp_date) {
                ...
                if (expDate < now) {
                    showFeedback(`✗ Cannot add expired batch item: ${item.item_name} (Batch: ${item.batch_no})`,
                        'error');
                    barcodeInput.value = '';
                    setTimeout(() => {
                        barcodeInput.focus();
    ...
    function addItemToBill(item) {
        ...
        if (existingRow) {
            ...
            if (currentStock < newQty) {
                ...
                showFeedback(
                    `✗ Insufficient stock for ${itemTypeText}. Available: ${currentStock}, Requested: ${newQty}`,
                    'error');
                return;
            }
    ...
    document.addEventListener('input', function(e) {
        if (e.target.classList.contains('item-qty')) {
            ...
            // alert("1397 item edit");

            const row = e.target.closest('tr');
            const qty = parseFloat(e.target.textContent) || 0;

            // Get price, discount, tax from the row (NOT from item object)
            const price = parseFloat(row.cells[4].textContent.replace('₹', '')) || 0;
            const discount = parseFloat(row.cells[5].textContent) || 0;
            const tax = parseFloat(row.cells[6].textContent) || 0;

            // console.log(price, discount, tax);

            // console.log(`task with ${tax}`);
            // return;
            ...
            // Final amount
            const amount = taxedPrice * qty;

            // Update amount cell
            // row.cells[7].textContent = `₹ ${amount.toFixed(2)}`;
    ...
    // check the dummy  item for the input form make teh idem ids



    $('.check_dummy').on('click', function() {

        const prefix = "dummy";

        let nextId; // ← use let, not const

        // if (itemsLoaded) {
        //     console.log(itemsData);
        // }

        // 1. Filter only items where ID starts with "dummy"
        const dummyItems = itemsData.filter(item =>
            item.id && item.id.toString().startsWith(prefix)
        );

        // 2. If no dummy IDs → return dummy01
        if (dummyItems.length === 0) {
            nextId = prefix + "01";
            // console.log("Next ID:", nextId);
        } else {
            // 3. Extract numeric part: dummy05 → 5
            const numericIds = dummyItems.map(item =>
            ...
            // 5. Create next ID
            nextId = prefix + (maxNum + 1).toString().padStart(2, '0');

            // console.log("Next ID:", nextId);
        }

        $('#dummy_item').val(nextId);
    ...
    document.addEventListener('submit', function(e) {
        if (e.target.id === 'manualItemForm') {
            e.preventDefault(); // stop form submit


            const item = {
                id: document.getElementById('dummy_item').value,
                batch_id: null,
                item_code: null,
                item_name: document.getElementById('manual_item_name').value,
                display_name: document.getElementById('manual_item_name').value,
                measure_unit: document.getElementById('manual_measure_unit').value,
                sales_price: parseFloat(document.getElementById('manual_price').value),
                gst_rate: parseFloat(document.getElementById('manual_gst_rate').value),
                discount: 0,
                current_stock: parseFloat(document.querySelector('input[name="stock"]').value),
                item_type: "manual",
                batch_no: "",
                barcode: "",
                qty: "",
            ...
            itemsData = itemsData.concat(item);
            document.getElementById("manualItemForm").reset();
            // console.log("dummy", itemsData);

            // console.log(item);
            // return;

            // console.log(item); // check object
            addItemToBill(item); // << send to your function

            // Close modal
            const modal = bootstrap.Modal.getInstance(document.getElementById('manual_item'));
            if (modal) modal.hide();
        }
    });
    ...
    function makeQuantityEditable(row) {
        ...
        qtyCell.addEventListener('blur', function() {
            ...
            // console.log(" item type 1529 " + itemType);
            ...
            let item;
            if (itemType === 'batch') {
                item = itemsData.find(i => i.id.toString() === itemId && i.batch_id && i.batch_id.toString() ===
                    batchId);
            } else {
    ...
    function applyBillDiscount() {
        ...
        const itemDiscounts = parseFloat(document.getElementById('itemDiscounts').textContent.replace('₹', '')
            .trim()) || 0;
    ...
    function updateTotals() {
        ...
        if (billDiscountData.type && billDiscountData.value > 0) {
            ...
            if (billDiscountData.timing === 'before') {
                ...
                discountBase = subtotal - totalItemDiscountAmount + totalItemTaxAmount - loyaltyPointsDiscount -
                    giftCardDiscount;
            }
        ...
        document.getElementById('itemDiscounts').textContent =
            `₹ ${totalItemDiscountAmount.toFixed(2)} (${avgDiscountPercent.toFixed(2)}%)`;
        document.getElementById('totalTax').textContent =
            `₹ ${totalItemTaxAmount.toFixed(2)} (${avgTaxPercent.toFixed(2)}%)`;
        ...
        const grandTotal = totalAmount + additionalChargesAmount - billDiscountAmount - loyaltyPointsDiscount -
            giftCardDiscount;
    ...
    document.addEventListener('click', function(e) {
        if (e.target.id === 'savePrintBtn' || e.target.closest('#savePrintBtn')) {
            ...
            const billData = {
                ...
                items: [],
                sub_total: parseFloat(document.getElementById('subTotal').textContent.replace(/[₹,\s]/g,
                    '')) || 0,
                total_discount: parseFloat(document.getElementById('itemDiscounts').textContent.replace(
                    /[₹,\s]/g, '')) || 0,
                total_tax: parseFloat(document.getElementById('totalTax').textContent.replace(/[₹,\s]/g,
                    '')) || 0,
                ...
                online_amount: mopValue === 'Both' ? onlineAmount : (mopValue === 'Online' ?
                    receivedAmount : 0),
        ...
        <div class="print-bill">
            ...
            <div class="totals-section">
                ...
                <div class="total-row">
                    ...
                    <span class="total-value">-₹${billData.item_discounts.toFixed(2)}</span>
                </div>
                ` : ''}
                ...
                <div class="total-row">
                    ...
                    <span class="total-value">-₹${billData.bill_discount.toFixed(2)}</span>
                </div>
                ` : ''}
                
                ${billData.total_gift_card_discount > 0 ? `
                <div class="total-row">
                    <span class="total-label">Gift Card/Voucher:</span>
                    <span class="total-value">-₹${billData.total_gift_card_discount.toFixed(2)}</span>
                </div>
                ` : ''}
            ...
            <div class="savings-section">
                ...
                ${totalSavings > 0 ? `<div style="font-size: 8px;">MRP Savings: ₹${totalSavings.toFixed(2)}</div>` : ''}
                ${totalDiscountSavings > 0 ? `<div style="font-size: 8px;">Discount Savings: ₹${totalDiscountSavings.toFixed(2)}</div>` : ''}
            </div>
            ` : ''}
    ...
    $(document).ready(function() {
        ...
        $('#savePrintBtn').on('click.saveBill', function(e) {
            ...
            if (selectedCustomerText && selectedCustomerText !== 'No customer selected' &&
                selectedCustomerText !== 'Sukoyo Store') {
            ...
            $('#addedTable tbody tr').each(function() {
                ...
                if (cells.length >= 8) {
                    ...
                    if (itemId && qty > 0 && price > 0) {
                        const actualItem = itemsData.find(i => i.id.toString() === itemId
                            .toString());
                        const itemData = {
                            // item_id: itemId === "0000" ? 0 : parseInt(itemId),
                            item_id: itemId,
                            name: itemName,
                            unit: unit,
                            qty: qty,
                            ...
                            tax: tax,
                            amount: amount,
                            mrp: actualItem ? parseFloat(actualItem.mrp || actualItem
                                .sales_price) : price
                        };

                        // console.log("cells", itemData);
            ...
            const additionalCharges = parseFloat($('#additionalCharges').text().replace(/₹|,|\s/g,
                '')) || 0;
            ...
            if (receivedAmount < grandTotal) {
                if (!confirm(
                        `Received amount (₹${receivedAmount.toFixed(2)}) is less than Grand Total (₹${grandTotal.toFixed(2)}). Continue anyway?`
                    )) {
                    $btn.prop('disabled', false).text(originalText);
                    return false;
                }
            ...
            // Get gift card data
            const giftCardData = typeof getGiftCardDataForSaving === 'function' ?
                getGiftCardDataForSaving() : {
                    applied_gift_cards: [],
                    total_gift_card_discount: 0
                };
            ...
            const payload = {
                ...
                bill_time: new Date().toLocaleTimeString('en-GB', {
                    hour12: false
                })
            };
            ...
            const csrfToken = $('meta[name="csrf-token"]').attr('content') || $('input[name="_token"]')
                .val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status || response.success) {
                        ...
                        alert("Failed to save bill: " + (response.message ||
                            "Unknown error"));
                        $btn.prop('disabled', false).text(originalText);
                    }
                },
                error: function(xhr, status, error) {
                    ...
                    if (status === 'timeout') {
                        errorMessage =
                            "Request timed out. Please check and refresh the page.";
    ...
    (function() {
        ...
        function initializeFirstScreen() {
            ...
            screenSpecificData['screen-1'] = {
                billDiscountData: typeof billDiscountData !== 'undefined' ? {
                    ...billDiscountData
                } : {
                    type: null,
                    value: 0,
                ...
                additionalChargesAmount: typeof additionalChargesAmount !== 'undefined' ?
                    additionalChargesAmount : 0,
                usedLoyaltyPoints: 0,
        ...
        function captureCurrentScreenData() {
            ...
            const selectedCustomerText = document.getElementById('selectedCustomer')?.textContent ||
                'No customer selected';
            let customerName = '';
            let customerContact = '';
            ...
            return {
                ...
                customer: {
                    ...
                    remainingPointsVisible: document.getElementById('remainingPointsContainer')?.style.display !==
                        'none',
        ...
        function saveCurrentScreenData() {
            if (screens[currentScreenId]) {
                ...
                if (screenSpecificData[currentScreenId]) {
                    screenSpecificData[currentScreenId].billDiscountData = typeof billDiscountData !== 'undefined' ?
                    {
                        ...billDiscountData
                    } : {
                        type: null,
                    ...
                    screenSpecificData[currentScreenId].additionalChargesAmount = typeof additionalChargesAmount !==
                        'undefined' ? additionalChargesAmount : 0;
                    screenSpecificData[currentScreenId].itemCount = typeof itemCount !== 'undefined' ? itemCount :
                        0;
        ...
        function saveGiftCardModalState() {
            ...
            const appliedAmount = giftCardDisplay ? parseFloat(giftCardDisplay.textContent.replace(/₹|,|\s/g,
                '')) || 0 : 0;
            ...
            if (giftCardModal) {
                ...
                cardSelections.forEach(checkbox => {
                    ...
                    if (cardRow) {
                        const cardData = {
                            ...
                            balance: parseFloat(cardRow.querySelector('.card-balance')?.textContent
                                ?.replace(/₹|,|\s/g, '')) || 0,
                            appliedAmount: parseFloat(cardRow.querySelector('.applied-amount')?.value ||
                                cardRow.querySelector('.applied-amount')?.textContent ||
                                '0')
                        };
                ...
                screenSpecificData[currentScreenId].giftCardModalData = {
                    ...
                    remainingBalance: screenSpecificData[currentScreenId].giftCardModalData?.remainingBalance ||
                        0
                };
            }
        }
        ...
        function loadScreenData(screenId) {
            ...
            if (screenSpecificData[screenId]) {
                if (typeof billDiscountData !== 'undefined') {
                    billDiscountData = {
                        ...screenSpecificData[screenId].billDiscountData
                    };
                }
            ...
            if (remainingPointsContainer) {
                remainingPointsContainer.style.display = screenData.customer.remainingPointsVisible ? 'block' :
                    'none';
            }
            ...
            setTimeout(() => {
                const barcodeInput = document.getElementById('barcodeInput');
                if (barcodeInput && typeof shouldAutoFocusBarcode === 'function' &&
                    shouldAutoFocusBarcode()) {
                    barcodeInput.focus();
                }
            }, 100);
        }
        ...
        function resetGiftCardModal() {
            ...
            const remainingBalanceDisplay = giftCardModal.querySelector(
                '.remaining-balance, #remainingGiftCardBalance');
        ...
        function restoreGiftCardModal() {
            ...
            if (!giftCardModal || !screenGiftCardData.appliedGiftCards || screenGiftCardData.appliedGiftCards
                .length === 0) {
                return;
            }
            ...
            screenGiftCardData.appliedGiftCards.forEach(cardData => {
                const checkbox = giftCardModal.querySelector(
                    `input[type="checkbox"][value="${cardData.id}"]`);
                if (checkbox) {
                    ...
                    const cardRow = checkbox.closest('tr') || checkbox.closest('.gift-card-item');
                    if (cardRow) {
                        const appliedAmountInput = cardRow.querySelector(
                            '.applied-amount, input[name*="applied"]');
            ...
            console.log('Gift card modal restored for screen:', currentScreenId, screenGiftCardData
                .appliedGiftCards);
        }
                    ...
                    modal.addEventListener('hidden.bs.modal', function() {
                        setTimeout(() => {
                            ...
                            if (modalId === 'giftcards') {
                                console.log(
                                    'Gift card modal closed, data saved for screen:',
                                    currentScreenId);
                            }
                        }, 100);
                    });
        ...
        function enhancedSaveBillOverride() {
            ...
            $(document).on('click', '#saveBillBtn, #savePrintBtn', function(e) {
                ...
                const itemDiscounts = parseFloat(screenData.totals.itemDiscounts.replace(/₹|,|\s/g, '')) ||
                    0;
                ...
                const additionalCharges = parseFloat(screenData.totals.additionalCharges.replace(/₹|,|\s/g,
                    '')) || 0;
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status || response.success) {
                            ...
                            currentButton.prop('disabled', false).text(buttonText);
                            showScreenNotification("Failed to save bill: " + (response
                                .message || response.error || "Unknown error"), 'error');
                        }
                    },
                    error: function(xhr, status, error) {
                        console.error('AJAX Error:', {
                        ...
                        try {
                            ...
                            if (xhr.status === 500) {
                                ...
                                errorMessage =
                                    "Session expired (419). Please refresh the page.";
                            }
                        }
