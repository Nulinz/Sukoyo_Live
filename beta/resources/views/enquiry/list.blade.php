                ...
                <table class="example table-bordered table">
                    ...
                    <tbody>
                        @foreach ($enquiries as $key => $enquiry)
                            <tr data-id="{{ $enquiry->id }}" data-enquiry_no="{{ $enquiry->enquiry_no }}" data-customer_name="{{ $enquiry->customer_name }}"
                                data-contact_number="{{ $enquiry->contact_number }}" data-item_name="{{ $enquiry->item_name }}" data-store_id="{{ $enquiry->store_id }}"
                                ...
                                <td>
                                    ...
                                    <button class="status-btn btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#statusEnquiry" data-id="{{ $enquiry->id }}"
                                        data-status="{{ $enquiry->status }}">
                                        Update Status
                                    </button>
                                </td>
