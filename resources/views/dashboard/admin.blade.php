...
@section('content')
        ...
        <div class="cardssub d-block">
            ...
            <h5>
                <span style="color: {{ $color }};">
                    <i class="fas {{ $arrowClass }} pe-1"></i>
                    {{ number_format(abs($salesDifference), 1) }}%
                </span>
                {{ $diffText }}
            </h5>
        </div>
        ...
        <div class="cardssub d-block">
            ...
            <h5>
                <span style="color: {{ $purchaseColor }};">
                    <i class="fas {{ $purchaseArrow }} pe-1"></i>
                    {{ number_format(abs($purchaseDifference), 1) }}%
                </span>
                {{ $purchaseText }}
            </h5>
        </div>
    ...
    <div class="cardsdiv">
        ...
        <div class="cardssub d-block">
            ...
            @endphp
            <h5>
                <span style="color: {{ $billColor }};">
                    <i class="fas {{ $billArrow }} pe-1"></i>
                    {{ number_format(abs($billDifference), 1) }}%
                </span>
                {{ $billText }}
            </h5>
        </div>
...
<div class="col-sm-6 col-md-4 col-xl-3 mb-3 cards">
    <div class="cardsdiv">
        <div class="cardsmain">
            <div>
                <h6>To Pay</h6>
                <h5>₹ {{ number_format($toPayAmount, 2) }}</h5>
            </div>
            <img src="{{ asset('assets/images/icon_8.png') }}" height="50px" alt="">
        </div>
        <div class="cardssub d-block">
            <h5>
                For {{ $vendorsToPay }} Vendor{{ $vendorsToPay > 1 ? 's' : '' }}
            </h5>
        </div>
    </div>
</div>
                   ...
                   <div class="cardsdiv">
                        <div class="cardsmain">
                            <div>
                                ...
                                <h4 class="mb-0">{{ $customersWithLoyalty }}</h4>
                            </div>
                            <img src="{{ asset('assets/images/icon_9.png') }}" height="75px" alt="">
                        </div>
                    </div>
                </div>
    ...
    <div class="cardsdiv">
        <div class="cardsmain">
            <div>
                ...
                <h4 class="mb-0">{{ $todayNewCustomersWithLoyalty }}</h4>
            </div>
    ...
    <div class="cardsdiv">
        <div class="cardsmain">
            <div>
                ...
                <h6 class="mb-2">With Loyalty Points</h6>
                <h4 class="mb-0">{{ $returningCustomersWithLoyalty }}</h4>
            </div>
...
<script>
    let target1 = {{ $loyaltyTargetPercent }};
    let target2 = {{ $returningCustomersPercent }};
