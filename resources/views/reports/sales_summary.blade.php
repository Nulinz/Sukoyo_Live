        ...
        <div class="filter-container">
            ...
            <div class="filter-container-end">
                ...
                <select class="form-select" name="payment_mode" id="payment_mode">
                    <option value="all" {{ $paymentMode == 'all' ? 'selected' : '' }}>All Payment Modes</option>
            ...
            <div class="col-md-3">
                <div class="card bg-info text-white">
                    <div class="card-body">
                        ...
                        <h4 id="cashSales">₹{{ number_format($cashSales) }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        ...
                        <h4 id="onlineSales">₹{{ number_format($onlineSales) }}</h4>
                    </div>
                </div>
            </div>
        </div> -->
...
<script>
    ...
    function loadSalesSummaryData() {
        ...
        // Fetch from API
        fetch(`{{ route('api.sales_summary_items') }}?${params.toString()}`)
...
function populateTable(sales) {
    ...
    function downloadReport() {
        ...
        window.location.href = `{{ route('reports.sales_summary') }}?${params.toString()}`;
    }
