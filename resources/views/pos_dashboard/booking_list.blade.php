...
<div class="body-div p-3">
    <div class="body-head">
        <h4>Bookings List</h4>
        <a href="{{ route('class.bookingsadd.data') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                  <a href="{{ route('class.bookingsprofile.data', ['id' => $booking->id]) }}" data-bs-toggle="tooltip" title="Profile">
    <i class="fas fa-arrow-up-right-from-square"></i>
</a>


                                    <a href="{{ route('class.bookingsedit.data', ['id' => $booking->id]) }}" data-bs-toggle="tooltip" title="Edit">
