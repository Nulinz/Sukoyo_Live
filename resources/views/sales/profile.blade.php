...
<div class="body-div p-3" id="printableArea">
    ...
    <div class="maincard row py-0 mb-3">
        ...
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
            ...
            <h5 class="mb-0">{{ $sale->invoice_date->format('d-m-Y') }}</h5>
        </div>
        <div class="col-sm-12 col-md-4 col-xl-3 mb-3">
...
<script>
    ...
    function printPage() {
        ...
        const printDocument = `
            ...
            <html>
            <head>
                <title>Sales Profile - {{ 'INV' . str_pad($sale->id, 4, '0', STR_PAD_LEFT) }}</title>
                <style>
                    * {
                        margin: 0;
                        padding: 0;
    ...
    function downloadPDF() {
        ...
        html2canvas(element, options).then(canvas => {
            ...
            const invoiceNo = '{{ "INV" . str_pad($sale->id, 4, "0", STR_PAD_LEFT) }}';
